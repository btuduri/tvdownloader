...
#		for inst in getattr( self.pluginManager, "listeInstances" ):
#			self.api.ajouterPlugin( inst )
#		plugins = self.pluginManager.listeInstances
		...
		while choice != 'exit':
			#ouverture du menu dperferences
			if choice == 'p' or choice == 'P': prefs()
